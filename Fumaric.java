...
public class Fumaric {
	...
	public static void main(String[] args) throws IOException {
		...
		String s="C:\\Users\\A\\Desktop\\React\\Input\\Acid, Fumaric, Powder Subs 44642.xlsx";
	...
	/*	for(int i=52;i<53;i++)
		...
		for(int j=0;j<colCount5;j++)
		   ...
		   if(j==1||j==2)
			   ...
			   {
			   Cell cell = row5.getCell(j);
			String	 str22= String.valueOf(cell);
				 str20+=str22;
		   ...
		   if(j==5)
		   			{
			   Cell cell = row5.getCell(j);
				String  str21= String.valueOf(cell);
				preparedStatement.setString(8,str21);

		   			}
		   String str18="null";
		   preparedStatement.setString(5, str18);
		   }
		preparedStatement.addBatch();
