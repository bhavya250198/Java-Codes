...
public class Lactic {
	...
	public static void main(String[] args) throws IOException {
		...
		String s="C:\\Users\\A\\Desktop\\React\\Input\\Acid, Lactic, 80 Solution, Purac FCC 80 Subs 44849.xlsx";
	  ...
	  //creating a new file instance  
		...
		Row row2= sheet.getRow(15);                              //Analytic Specifications
		...
		for(int j=0;j<colCount1;j++)
		   {		
				...
				if(j==4)
				{
					Cell cell4 = row1.getCell(j);
					String str11= String.valueOf(cell4);
					preparedStatement.setString(7,str11);
				}
				if(j== 2|| j==3)
				{	
		...
		Row row3= sheet.getRow(51);                              //Analytical Specifications
